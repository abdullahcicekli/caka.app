...
export const es = {
  ...
  hero: {
    ...
    tower: {
      elif: { youtube: "Detrás del episodio 40" },
      sena: { bio: "Fisioterapia · Ankara" },
      selin: { link: "Nueva colección: Toprak" },
      ozan: { link: "Fechas de conciertos" },
      onur: { location: "Bodrum, Muğla", country: "Turquía" },
      yusuf: { document: "Menú de la semana" },
      serkan: { status: "Inscripciones abiertas" },
      rabia: { text: "Escríbeme para trabajos de ilustración." },
      can: { status: "Sesión del sábado" },
      furkan: { link: "Nuevo relato: Uzun Yol" },
      kaan: { bio: "Vídeo · Estambul" },
      deniz: { bio: "Docente · Eskişehir" },
      tolga: { status: "Nuevas láminas en camino" },
      volkan: { status: "Carrera del domingo 7:00" },
      ahmet: { bio: "Bicicletas · Esmirna" },
      esra: { link: "Formulario de pedido" },
    },
